    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-xl font-semibold tracking-tight">Concerns</h1>
        </div>
        <Button size="sm" className="h-8 text-[13px]" onClick={openAdd}><Plus className="h-4 w-4 mr-1" /> Add Concern</Button>
      </div>
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="text-[11px] uppercase tracking-wide">Concern Name</TableHead>
            ...
            <TableBody>
              {loading ? (
                ...
                <TableRow key={item.id} className="cursor-pointer hover:bg-muted/50" onClick={() => openEdit(item)}>
                  ...
                  <TableCell className="text-[13px] font-medium">{item.concernName}</TableCell>
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-1.5">
              <Label className="text-[13px]">Concern Name <span className="text-destructive">*</span></Label>
